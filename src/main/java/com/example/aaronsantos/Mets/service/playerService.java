...
public class playerService {
    ...
    public playerService() {
        ...
        player p1 = new player(0,5,"david wright","right","right", 1982,2004,2018, "3B", 7,49.2);
        player p2 = new player(1,18,"daryl strawberry","left","left", 1962,1983,1999, "RF", 8,42.2);
        player p3= new player(2,15,"carlos beltran","switch","right", 1977,1998,2017, "CF", 9, 70.1);
        player p4= new player(3,13,"edgar alfonzo","right","right", 1973,1995,2006, "2B", 1,28.7);
